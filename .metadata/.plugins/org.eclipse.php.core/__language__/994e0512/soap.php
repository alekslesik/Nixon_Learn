...
class SoapVar  {
	 ...
	 * @param mixed $type_name [optional]
	 * @param mixed $type_namespace [optional]
	 * @param mixed $node_name [optional]
	 * @param mixed $node_namespace [optional]
	 */
...
class SoapFault extends Exception implements Throwable {
	 ...
	 * @param mixed $faultactor [optional]
	 * @param mixed $detail [optional]
	 * @param mixed $faultname [optional]
...
class SoapHeader  {
	 ...
	 * @param mixed $mustunderstand [optional]
	 * @param mixed $actor [optional]
	 */
 ...
 * @param mixed $object The object to connect.
