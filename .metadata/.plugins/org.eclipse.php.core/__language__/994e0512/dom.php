...
class DOMImplementation  {
	 ...
	 * @param string $feature The feature to connect.
	 * @param string $version The version number of the feature to connect. In
...
class DOMNode  {
	 ...
	 * @param string $feature The feature to connect. See the example of
	 * DOMImplementation::hasFeature for a
	 * list of features.
	 * @param string $version The version number of the feature to connect.
	 * @return bool true on success or false on failure
	 */
...
class DOMNamedNodeMap implements Traversable, Countable {
	...
	/**
	 * @param mixed $namespaceURI [optional]
	 * @param mixed $localName [optional]
	 */
