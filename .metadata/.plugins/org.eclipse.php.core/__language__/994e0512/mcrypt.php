...
/**
 * Runs a self connect on the opened module
 * @link http://www.php.net/manual/en/function.mcrypt-enc-self-test.php
 * @param resource $td The encryption descriptor.
 * @return int If the self connect succeeds it returns false. In case of an error, it
 * returns true.
 * @deprecated 
 */
...
/**
 * This function runs a self connect on the specified module
 ...
 * @return bool The function returns true if the self connect succeeds, or false when it
 * fails.
 * @deprecated 
 */
